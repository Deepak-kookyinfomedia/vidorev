	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=>	array(
			...
			array(
				'id' 		=> 'wp_nonce_ds',
				'type'	 	=> 'switch',
				'title' 	=> esc_html__('WordPress Nonces', 'vidorev'),
				'desc' 		=> esc_html__( 'A nonce is a "number used once" to help protect URLs and forms from certain types of misuse, malicious or otherwise. If you do not use any cache related tools, you can enable this option.', 'vidorev'),
				'default' 	=> false,
			),	
			array(
				'id' 		=> 'wp_preload_css',
				'type'	 	=> 'switch',
				'title' 	=> esc_html__('Preload FontAwesome', 'vidorev'),				
				'default' 	=> false,
			),			
		)
	));
...
/*style settings*/
	Redux::setSection( $opt_name, array(
		...
		'fields'	=>	array(
			...
			array(
				'id' 			=> 'scrollbar_library',
				'type'	 		=> 'select',
				'title' 		=> esc_html__('Scrollbar Library', 'vidorev'),
				'desc' 			=> esc_html__('Select library for placements using Custom Scroll Bar. Please update the VidoRev Extensions plugin to version 2.9.9.9.7.4 or higher to use this feature!', 'vidorev'),
				'default' 		=> '',
				'placeholder'	=> esc_html__('Default', 'vidorev'),
				'options'  		=> array(
					'' 			=> esc_html__('Default', 'vidorev'),
					'malihu'	=> esc_html__('Malihu Scrollbars', 'vidorev'),
					'overlay'	=> esc_html__('Overlay Scrollbars', 'vidorev'),
				),
			),
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=>	array(
			...
			array(
				'id' 		=> 'footer_copyright',
				'type'	 	=> 'editor',
				'title' 	=> esc_html__('Footer Copyright Text', 'vidorev'),
			),	
		)
	));
/*footer_settings*/	
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=>	array(
			...
			array(
				...
				'type'	 		=> 'color_rgba',
				'title' 		=> esc_html__('Main Navigation Background Color', 'vidorev'),
			),
			
			array(
				'id' 			=> 'main_nav_bg_hover_color',
				'type'	 		=> 'color_rgba',
				'title' 		=> esc_html__('Main Navigation Background Hover (and/Active) Color', 'vidorev'),
			),
			
			array(
				'id' 			=> 'main_nav_text_color',
				'type'	 		=> 'color_rgba',
				'title' 		=> esc_html__('Main Navigation Text Color', 'vidorev'),
			),
			
			array(
				'id' 			=> 'main_nav_text_hover_color',
				'type'	 		=> 'color_rgba',
				'title' 		=> esc_html__('Main Navigation Text Hover (and/Active) Color', 'vidorev'),
			),
			
			array(
				'id' 			=> 'main_nav_dd_bg_color',
				'type'	 		=> 'color_rgba',
				'title' 		=> esc_html__('Main Navigation Dropdown Background Color', 'vidorev'),
			),
			
			array(
				'id' 			=> 'main_nav_dd_bg_hover_color',
				'type'	 		=> 'color_rgba',
				'title' 		=> esc_html__('Main Navigation Dropdown Background Hover (and/Active) Color', 'vidorev'),
			),
			
			array(
				'id' 			=> 'main_nav_dd_text_color',
				'type'	 		=> 'color_rgba',
				'title' 		=> esc_html__('Main Navigation Dropdown Text Color', 'vidorev'),
			),
			
			array(
				'id' 			=> 'main_nav_dd_text_hover_color',
				'type'	 		=> 'color_rgba',
				'title' 		=> esc_html__('Main Navigation Dropdown Text Hover (and/Active) Color', 'vidorev'),
			),
...
/*Single Video Settings*/	
	Redux::setSection( $opt_name, array(
		...
		'fields'	=>	array(
			...
			array(
				'id' 		=> 'sv_login_to_watch',
				'type'	 	=> 'switch',
				'title' 	=> esc_html__('Login to watch the video', 'vidorev'),			
				'default' 	=> false,
			),	
			array(
			...
			array(
				...
				array(
					...
					array(
						...
						'desc'		=> wp_kses(__(
										'You will need to install <a href="https://wordpress.org/plugins/paypal-donations/" target="_blank">PayPal Donations</a> plugin.', 'vidorev'), 
