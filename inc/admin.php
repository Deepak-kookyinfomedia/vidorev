...
if ( ! function_exists( 'vidorev_scripts_admin' ) ) :
	function vidorev_scripts_admin() {
		wp_enqueue_style( 'admin_css', get_template_directory_uri() . '/css/admin.css', array(), '2.9.9.9.8.8');	
		...
		wp_enqueue_script( 'admin_javascript', get_template_directory_uri() . '/js/admin.js', array( 'jquery' ), '2.9.9.9.8.8', true  );	
